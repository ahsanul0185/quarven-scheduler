  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
      <div className="p-6 border-b border-slate-200">
        <h3 className="text-lg text-slate-700">Problems</h3>
        ...
        <table className="w-full text-sm border-collapse">
          <thead className="sticky top-0 z-20">
            <tr className="bg-[#2C3E50] text-white">
              <th className="px-6 py-4 text-left font-light">Type</th>
              <th className="px-6 py-4 text-left font-light">Shift</th>
              <th className="px-6 py-4 text-left font-light">Site / Role</th>
              <th className="px-6 py-4 text-left font-light">Day</th>
              <th className="px-6 py-4 text-left font-light">Detail</th>
            </tr>
          </thead>
          <tbody>
            {sorted.map((conflict, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-slate-600 font-light">{conflict.shift_id}</td>
                <td className="px-6 py-4 text-slate-600 font-light">
                  {conflict.site} / <span className="capitalize">{conflict.role}</span>
                </td>
                <td className="px-6 py-4 text-slate-600 font-light capitalize">{conflict.day}</td>
                <td className="px-6 py-4 text-slate-600 font-light">{conflict.detail}</td>
              </tr>
            ))}
          </tbody>
        </table>
